...
class EditProductInWarehouse extends StatefulWidget {
  const EditProductInWarehouse({
    super.key,
  ...
  @override
  State<EditProductInWarehouse> createState() => _EditProductInWarehouse();
}

class _EditProductInWarehouse extends State<EditProductInWarehouse> {
